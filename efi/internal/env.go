...
// XXX: The interfaces here are really public, but they are here because they are shared by
...
// the TCG event log. This must be kept in sync with [efi.HostEnvironment].
type HostEnvironmentEFI interface {
	// VarContext returns a context containing a efi.VarsBackend, keyed by efi.VarsBackendKey,
